...
var game = (function () {
    ...
    function preloadImages () {
        for (var i = 1; i <= 8; i++) {
            ...
            evilImage.src = 'Img/malo' + i + '.png';
            evilImages.animation[i-1] = evilImage;
            var bossImage = new Image();
            bossImage.src = 'Img/jefe' + i + '.png';
            bossImages.animation[i-1] = bossImage;
        }
        evilImages.killed.src = 'Img/malo_muerto.png';
        bossImages.killed.src = 'Img/jefe_muerto.png';
        bgMain = new Image();
        bgMain.src = 'Img/fondovertical.png';
        bgBoss = new Image();
        bgBoss.src = 'Img/fondovertical_jefe.png';
        playerShotImage = new Image();
        playerShotImage.src = 'Img/disparo_bueno.png';
        evilShotImage = new Image();
        evilShotImage.src = 'Img/disparo_malo.png';
        playerKilledImage = new Image();
        playerKilledImage.src = 'Img/bueno_muerto.png';
    ...
    function showLifeAndScore () {
        bufferctx.fillStyle="rgb(253, 254, 254)";
        bufferctx.font="bold 16px Arial";
        bufferctx.fillText("Puntos: " + player.score, canvas.width - 100, 50);
        bufferctx.fillText("Vidas:  "+" "+" "+ player.life, canvas.width - 100,70);
    }
    ...
    function showGameOver() {
        ...
        bufferctx.fillText("ESTAS PERDIDO", canvas.width / 2 - 100, canvas.height / 2);
    }

    function showCongratulations () {
        bufferctx.fillStyle="rgb(255, 248, 220)";
        bufferctx.font="bold 22px Arial";
        bufferctx.fillText("Has Ganado", canvas.width / 2 - 200, canvas.height / 2 - 30);
        bufferctx.fillText("PUNTOS: " + player.score, canvas.width / 2 - 200, canvas.height / 2);
        bufferctx.fillText("VIDAS: " + player.life + " de 3", canvas.width / 2 - 200, canvas.height / 2 + 30);
        bufferctx.fillText("TOTAL: " + getTotalScore(), canvas.width / 2 - 200, canvas.height / 2 + 70);
    }
    ...
    function clearList(list) {
        list.innerHTML = '';
        addListElement(list, "<th>FECHA&nbsp&nbsp&nbspPUNTOS</th>");
